...
use log::info;
use radixdb::store::{Blob, OwnedBlob};
...
impl WebCacheFile {
    ...
    pub(crate) async fn load_length_prefixed(&self, start: u64) -> anyhow::Result<OwnedBlob> {
        ...
        let res = Blob::copy_from_slice(&res[4..len + 4]);
